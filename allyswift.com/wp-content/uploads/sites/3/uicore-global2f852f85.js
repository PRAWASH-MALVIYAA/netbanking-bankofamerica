        ...
        jQuery(document).ready(function() {
            ...
            e(document).ready(function() {
                if (jQuery(".uicore-progress-bar").length) {
                    ...
                    jQuery(window).scroll(t), e(window).on("resize", function() {
                        u = o(), t()
                    })
                }
            })
        ...
        jQuery(function(e) {
            e(document).ready(function() {
                ...
                function n() {
                    ...
                    }(), e(".uicore-mobile-menu-wrapper .menu-item-has-children > a:not(.ui-custom-tap)").bind("click", r), e(".uicore-mobile-menu-wrapper .uicore-menu-container .sub-menu .back > a").bind("click", u)) : e(".uicore-mobile-menu-wrapper .menu-item-has-children > a:not(.ui-custom-tap)").bind("click", o), e(".uicore-mobile-menu-wrapper li:not(.menu-item-has-children):not(.back) > a").bind("click", m), window.uicoreParent || (window.uicoreParent = !0, e(".uicore-mobile-menu-wrapper .uicore-menu-container .menu-item-has-children").each(function(i, n) {
                ...
                function r(i) {
                    ...
                    "0" == o || "0%" == o || "" == o ? n = "-100%" : (o = o.replace("-", "").replace("%", ""), n = "-" + (parseInt(o) + 100) + "%"), "1" === uicore_frontend.rtl && (n = n.replace("-", "+")), e(".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu").delay(200).animate({
                        left: n
                    }, 300, function() {
                        d(), e(".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu ").removeClass("uicore-animating")
                    })
                }
                ...
                function u(i) {
                    ...
                    }, 400), e(".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu").delay(200).animate({
                        left: n
                    }, 300, function() {
                        e(".uicore-mobile-menu-wrapper .uicore-menu .sub-menu:not(.uicore-active) li").removeClass("uicore-visible"), d(), e(".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu ").removeClass("uicore-animating")
                    })
                }
                ...
                function a(i) {
                    e(this).parent().find(".sub-menu:first").toggleClass("uicore-active"), e(this).parent().find(".sub-menu:first").slideToggle(), e(this).parent().find(".sub-menu:first").hasClass("uicore-active") ? d() : e(this).parent().find("li").removeClass("uicore-visible")
                }
                ...
                function m(n) {
                    ...
                    if (!window.uicoreAnimation) {
                        ...
                        if (document.body.classList.contains("uicore-overflow-hidden")) e(".uicore-mobile-menu-overflow").removeClass("uicore-overflow-hidden"), e("body").removeClass("uicore-overflow-hidden"), e("body").removeClass("uicore-mobile-nav-show"), i ? e(".uicore-animate-fade").length > 0 ? e(".uicore-navigation-wrapper").animate({
                            opacity: 0
                        }, 100) : setTimeout(function() {
                            e(".uicore-navigation-wrapper").animate({
                                opacity: 0
                            }, 50)
                        }, 100) : e(".uicore-navigation-wrapper").animate({
                            opacity: 0
                            ...
                            }, 0 + c)) : e(".uicore-navigation-wrapper").animate({
                                opacity: 1
                            }, 100), e("body").addClass("uicore-overflow-hidden"), setTimeout(function() {
                                e("body").addClass("uicore-mobile-nav-show"), e(".uicore-mobile-menu-overflow").addClass("uicore-overflow-hidden"), e(".uicore-mobile-menu-wrapper .uicore-menu-container").css("left", "0%"), d()
                            }, 50 + c)
                        }
...
window.addEventListener('DOMContentLoaded', () => {
    jQuery(' input[type="button"], input[type="submit"], .elementor-button.elementor-button, .elementor-button:not(.bdt-offcanvas-button), .bdt-button-primary, .bdt-ep-button,button.metform-btn,button.metform-btn:not(.toggle), .bdt-callout a.bdt-callout-button, [type="submit"], .tutor-button, .tutor-login-form-wrap input[type="submit"], .wp-block-button__link,.uicore-mobile-menu-wrapper .uicore-cta-wrapper a,.uicore-left-menu .uicore-cta-wrapper a,.uicore-navbar a.uicore-btn, .bdt-contact-form .elementor-button,.ui-attract').on('mouseenter', function(e) {
        var animClass = 'elementor-animation-flip';
        if (!jQuery(this).hasClass(animClass)) {
