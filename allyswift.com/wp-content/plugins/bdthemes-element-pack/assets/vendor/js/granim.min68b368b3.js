/*! Granim v2.0.0 - https://sarcadass.github.io/granim.js */ ! function t(e, i, s) {
    function o(r, a) {
        if (!i[r]) {
            if (!e[r]) {
    ...
    2: [function(t, e, i) {
        ...
        e.exports = function(t) {
            var e, i, s, o = t - this.previousTimeStamp > 100,
    ...
    14: [function(t, e, i) {
        ...
        e.exports = function() {
            ...
            for (t = 0; t < this.currentColors.length; t++)
                for (i.push([]), e = 0; e < 4; e++) i[t].push(this.currentColors[t][e]);
            return i
        }
    }, {}],
    15: [function(t, e, i) {
